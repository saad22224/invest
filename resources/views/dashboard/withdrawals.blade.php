                                    ...
                                    @foreach ($withdrawls as $withdrawl)
                                        <tr>
                                            <td class="p-0 p-md-3 d-md-flex">
                                                <p class="mt-3 mt-lg-4 mt-sm-1 ms-2">  {{$withdrawl->user->name}}</p>
                                            </td>
                                            <td class="email-column font">{{$withdrawl->user->email}}</td>
                                                ...
                                                <td class="font">
                                                    {{$withdrawl->usdt ?? 'لا يوجد'}}
                                             </td>
                                     
                                            <td class="pe-md-5 pe-0">
                                                {{$withdrawl->western ?? 'لا يوجد'}}
                                            </td>

                                            <td class="pe-md-5 pe-0">
                                                {{$withdrawl->bank ?? 'لا يوجد'}}
                                            </td>
                                            <td class="pe-md-5 pe-0">
                                                {{$withdrawl->money_office ?? 'لا يوجد'}}
                                            </td>



                                            <td class="ps-md-5 pe-md-5 ps-0 pe-0">
                                                <form action="{{ route('withdrawls.destroy', $withdrawl->id) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
