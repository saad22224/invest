                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="card p-4 shadow ms-2 mt-4 mt-md-0 ms-md-0">
                                    <div class="d-flex justify-content-between card_img">
                                        <img src="{{ asset('admin/assets/Vector 20 (1).png') }}" alt="line">
                                        <div class="me-5">
                                            <h5>$9,250</h5>
                                    ...
                                    <hr>
                                    <div class="d-flex justify-content-between  card_img">
                                        <img src="{{ asset('admin/assets/Vector 21 (1).png') }}" alt="line">
                                        <div class="me-3">
                                            <h5>$18,812</h5>
                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="card p-4 shadow ms-2 ms-md-0">
                                    ...
                                    <ul class="list-unstyled mt-4">
                                        <li class="mb-4"><span class="text-success">●</span> <strong>Geo Vanni</strong> started a new trial <span class
